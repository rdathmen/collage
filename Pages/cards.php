...
<body class="text-gray-900 transition-colors duration-300">
            ...
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="flex-shrink-0 flex items-center gap-3">
                    <a href="../index.php" class="flex items-center gap-3">
                        <div
                            ...
                            C</div>
                        <span class="font-bold text-2xl text-gray-800 dark:text-white tracking-tight">الكيمياء<span
                                class="text-teal-600">.العضوية</span></span>
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-8 ">
                    ...
                    <button
                        ...
                        <!-- Sun Icon -->
                        <svg class="w-6 h-6 hidden dark:block text-yellow-400" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                        <!-- Moon Icon -->
                        <svg class="w-6 h-6 block dark:hidden text-gray-600" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="md:hidden flex items-center">
                    ...
                    <button
                        class="theme-toggle p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors ml-2"
                        aria-label="Toggle Dark Mode">
                        <!-- Sun Icon -->
                        <svg class="w-6 h-6 hidden dark:block text-yellow-400" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="alkanes.html"
                ...
                <div class="h-48 bg-gray-200 relative overflow-hidden">
                    ...
                    <div class="absolute bottom-4 right-4 text-white">
                        ...
                        <h3 class="text-2xl font-bold">الألكانات</h3>
                    </div>
                </div>
                <div class="p-6">
                    <div class="flex justify-between items-center mb-2">
            ...
            <a href="alkyl_halides.html"
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed" style="line-height: 1.6;">
                        تعريف، تصنيف، تسمية، تحضير، وأهم تفاعلات هاليدات الألكيل مع أمثلة وتمارين.
                    </p>
                </div>
            </a>
            ...
            <a href="alcohols.html"
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed" style="line-height: 1.6;">
                        مركبات عضوية تحتوي على مجموعة هيدروكسيل (-OH) مرتبطة بذرة كربون مشبعة.
                    </p>
                </div>
            </a>
            ...
            <a href="ethers.html"
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed" style="line-height: 1.6;">
                        مركبات عضوية تحتوي على ذرة أكسجين مرتبطة بمجموعتي ألكيل أو أريل.
                    </p>
                </div>
            </a>
            ...
            <a href="alkenes.html"
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed" style="line-height: 1.6;">
                        هيدروكربونات غير مشبعة تحتوي على رابطة مزدوجة واحدة على الأقل بين ذرتي كربون.
                    </p>
                </div>
            </a>
            ...
            <a href="alkynes.html"
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed" style="line-height: 1.6;">
                        هيدروكربونات غير مشبعة تحتوي على رابطة ثلاثية واحدة على الأقل بين ذرتي كربون.
                    </p>
                </div>
            </a>
            ...
            <a href="aldehydes_and_ketones.html"
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed" style="line-height: 1.6;">
                        مركبات عضوية تحتوي على مجموعة كربونيل (C=O) في نهاية السلسلة أو في الوسط.
                    </p>
                </div>
            </a>
            ...
            <a href="amines.html"
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed" style="line-height: 1.6;">
                        مركبات عضوية تحتوي على ذرة نيتروجين مرتبطة بذرة كربون أو أكثر.
                    </p>
                </div>
            </a>
            ...
            <a href="nitro_compounds.html"
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed" style="line-height: 1.6;">
                        مركبات عضوية تحتوي على مجموعة نترو (-NO₂) مرتبطة بذرة كربون.
                    </p>
                </div>
            </a>
    ...
    <!-- Footer -->
    <footer class="bg-gray-900 text-gray-300 py-12 border-t border-gray-800 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <div class="flex items-center justify-center gap-2 mb-4">
                    <div class="w-8 h-8 bg-teal-600 rounded-lg flex items-center justify-center text-white font-bold">C
                    </div>
                    <span class="font-bold text-xl text-white">الكيمياء.العضوية</span>
                </div>
                <p class="text-sm text-gray-500">&copy; 2025 جميع الحقوق محفوظة.</p>
            </div>
        </div>
    </footer>
